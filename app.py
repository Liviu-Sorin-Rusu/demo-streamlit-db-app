###     Curs 26 – Integrare Streamlit cu baze de date, autentificare și deployment pe cloud
...
##      3. Deployment gratuit cu Streamlit Cloud

#       Pas 1.  Creăm un repo pe GitHub (ex: streamlit-db-app)

#       Pas 2.  Adăugăm fișierele:

#       A.  app.py (codul Streamlit)
#       B.  requirements.txt cu:

#       streamlit
#       pandas
#       matplotlib

#       C. users_data.db (baza de date)

#       Pas 3.  Accesăm Streamlit Cloud

#       Pas 4.  Autentificare cu GitHub

#       Pas 5.  Selectare repository

#       Pas 6.  Rulare aplicație online gratuit
